...
import LikeFilledIcon from "../../assets/icons/likedFile.png";
  ...
  const {auth} = useAuth()
    ...
    return (
        <div className="flex items-center justify-between py-6 lg:px-10 lg:py-8">
            <button 
              onClick={handleLike}
            className="flex-center gap-2 w-8 rounded text-xs font-bold text-[#B8BBBF] hover:text-white lg:text-sm">
